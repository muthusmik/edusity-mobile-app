...
export const LevelIcon=require("../assets/icons/risk.png");
export const Tutor=require("../assets/icons/homeschooling.png")
export const begginner=require("../assets/icons/begginner.png")
export const intermediate=require("../assets/icons/average.png");
