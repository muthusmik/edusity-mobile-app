    ...
    return (
        <View style={styles.container}>
            <View style={styles.announcementStyle}>
                <Text style={{ ...FONTS.robotomedium, color: COLORS.black, fontSize: 16, marginBottom: 8 }}>Course Announcements (<Text style={{ color: "red" }}>{announcement?.length}</Text>)</Text>
                <ScrollView>
...
export default CourseAnnouncementDashboard;