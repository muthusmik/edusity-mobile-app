    ...
    return (
        (!loader) ?
            <SafeAreaView>
                ...
                />
                <View style={{ height: "100%", width: "100%", backgroundColor: COLORS.lightGray }}>
                    {(CoursesCount > 0) ?
                        <>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item }) => (
                                    <View style={{ backgroundColor: COLORS.white, width: "95%", marginBottom: 10, borderRadius: 10, alignSelf: "center" }}>
