...
export const razorPayDevKeyId = "rzp_test_R94MOyaBT9hs94";
export const razorPayDevSecret = "7mktjA0AkoafnNWLU1LWRgEZ";
...
export const verificationLinkUrl = baseUrl + "get-verification-link"; //https://dev-login.edusity.com/get-verification-link
